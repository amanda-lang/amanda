...
class LexerTestCase(unittest.TestCase):
    ...
    def test_logic_operators(self):
        ...
        self.assertEqual(
            lexer.get_token().token, TokenType.GREATER, msg="GREATER Test Failed"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            lexer.get_token().token, TokenType.GREATEREQ, msg="GREATEREQ Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token, TokenType.NOTEQUAL, msg="NOTEQUAL Test Failed"
        )
        self.assertEqual(
    ...
    def test_arit_operators(self):
        ...
        self.assertEqual(
            lexer.get_token().token, TokenType.MINUSEQ, msg="MINUSEQ Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token, TokenType.STAREQ, msg="STAREQ Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token, TokenType.SLASHEQ, msg="SLASHEQ Test Failed"
        )
    ...
    def test_string(self):
        ...
        self.assertEqual(
            token.lexeme, "'Rambo jndjnsjndnsjns'", msg="STRING value test Failed"
        )
        token = lexer.get_token()
        self.assertEqual(token.token, TokenType.STRING, msg="STRING Test Failed")
