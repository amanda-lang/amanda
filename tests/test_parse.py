...
class LexerTestCase(unittest.TestCase):
    ...
    def test_logic_operators(self):
        ...
        self.assertEqual(
            lexer.get_token().token, TokenType.LESS, msg="LESS Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token, TokenType.LESSEQ, msg="LESSEQ Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token,
            TokenType.GREATEREQ,
        ...
        self.assertEqual(
            lexer.get_token().token, TokenType.EQUAL, msg="EQUAL Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token, TokenType.E, msg="E Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token, TokenType.OU, msg="OU Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token, TokenType.NAO, msg="NAO Test Failed"
        )
    ...
    def test_arit_operators(self):
        ...
        lexer = Lexer(self.buffer)
        self.assertEqual(
            lexer.get_token().token, TokenType.PLUS, msg="PLUS Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token, TokenType.MINUS, msg="MINUS Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token, TokenType.STAR, msg="STAR Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token, TokenType.SLASH, msg="SLASH Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token,
        ...
        self.assertEqual(
            lexer.get_token().token, TokenType.MODULO, msg="MODULO Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token, TokenType.PLUSEQ, msg="PLUSEQ Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token,
            TokenType.MINUSEQ,
        ...
        self.assertEqual(
            lexer.get_token().token, TokenType.STAREQ, msg="STAREQ Test Failed"
        )
        self.assertEqual(
            lexer.get_token().token,
            TokenType.SLASHEQ,
    ...
    def test_identifier(self):
        self.buffer.write(
            "_test1 test test2 __test3 nulo var mostra verdadeiro falso retorna se senao enquanto entao inc para faca de fim func classe eu super vazio converte inclua como"
        )
        self.buffer.seek(0)
        lexer = Lexer(self.buffer)
        token = lexer.get_token()
        ...
        token = lexer.get_token()
        self.assertEqual(
            token.token, TokenType.INCLUA, msg="INCLUA Test Failed"
        )
        self.assertEqual(token.lexeme, "inclua", msg="INCLUA value test Failed")
        token = lexer.get_token()
...
class ParserTestCase(unittest.TestCase):
    ...
    def test_inclua(self):
        phrases = [
            "\n\ninclua 'calc'",
            "\ninclua 'calc'",
            "inclua 'calc' como calculo\n\n",
            'inclua "calc.ama" como calculo\n',
        ]
        for phrase in phrases:
            print(phrase, file=self.buffer)
        # self.buffer.writelines(phrases)
